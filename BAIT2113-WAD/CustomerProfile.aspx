<%@ Page Title="" Language="C#" MasterPageFile="~/Gallerion.Master" AutoEventWireup="true" CodeBehind="CustomerProfile.aspx.cs" Inherits="BAIT2113_WAD.WebForm6" %>
            ...
            <div class=" d-block justify-content-center">
                <div class="area2 p- text-center px-3">
                    <div class="image mr-3">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [name], [email], [dob], [phoneNum] FROM [Customer] WHERE ([customerID] = @customerID)">
                            <SelectParameters>
