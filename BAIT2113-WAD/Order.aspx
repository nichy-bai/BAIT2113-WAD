...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="heading" style="font-family:'Times New Roman', Times, serif">Product Information</div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [name] FROM [Artist] WHERE ([artistID] = @artistID)">
            <SelectParameters>
                <asp:SessionParameter Name="artistID" SessionField="artistID" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        
       <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Artwork] WHERE ([artworkName] = @artworkName)">
           <SelectParameters>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>
                                <asp:DetailsView ID="artworkName" runat="server" AutoGenerateRows="False" Height="50px" Width="250px" GridLines="None" style="font-family: 'Roboto'" DataSourceID="SqlDataSource2" DataKeyNames="artworkID">
                                    <Fields>
                                        <asp:BoundField DataField="artworkID" HeaderText="artworkID" SortExpression="artworkID" ReadOnly="True" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="details_view" style="border: 0px none #FFFFFF; background-color: #FFFFFF; font-family: 'Roboto'; font-size: large; font-weight: normal; font-style: italic; font-variant: normal;">
                                <asp:DetailsView ID="orderDetails" runat="server" AutoGenerateRows="False" GridLines="None" Height="50px" Width="635px" CssClass="auto-style1" DataKeyNames="artworkID" DataSourceID="SqlDataSource2">
                                    <Fields>
