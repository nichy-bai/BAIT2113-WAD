            ...
            <div class="order-body-row">
                <div class="order-detail-col">
                    ...
                    <div>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="The quantity text field cannot be blank." ControlToValidate="txtQuantity" ForeColor="Red">The quantity text field cannot be blank.</asp:RequiredFieldValidator>
                    </div>
                </div>
