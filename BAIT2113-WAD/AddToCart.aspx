...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="profile-box">
        ...
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="No" AllowPaging="True" AllowSorting="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" CssClass="profile-gridview">
                <Columns>
                    ...
                    <asp:BoundField DataField="No" HeaderText="No" SortExpression="No" ItemStyle-Width="200px" ReadOnly="True" />
                    ...
                    <asp:BoundField DataField="subtotal" HeaderText="subtotal" ReadOnly="True" SortExpression="subtotal"  ItemStyle-Width="200px"/>
                </Columns>
