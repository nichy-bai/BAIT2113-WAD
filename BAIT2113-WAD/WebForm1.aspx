<%@ Page Title="" Language="C#" MasterPageFile="~/Gallerion.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="BAIT2113_WAD.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <script src="http://code.jquery.com/jquery-1.10.2.min.js" type="text/javascript"></script>
    ...
    <div class="profile-box">
        ...
        <asp:ValidationSummary ID="ValidationSummary1" runat="server"ValidationGroup="addartwork" />
    </div>
